...
Итог: технически задача была закрыта по части ACF и сравнения, но проект завершился через арбитраж и компенсацию из-за конфликтной коммуникации и прекращения сотрудничества.
